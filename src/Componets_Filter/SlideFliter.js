...
import CloseIcon from "../assets/Filter_Side/Close.svg"; 
import './style.css';
...
const SlideFliter  = () => {
    ...
    return (
        <aside className="w-1/4 h-80 bg-white p-4 rounded-lg shadow-md mb-6">
            ...
            <section className="flex flex-col gap-y-6 mt-6">
                ...
                <div className='flex flex-col'>
                    ...
                    <div className="relative mt-5 mx-auto w-full max-w-xs">
                        <input
                            type="range"
                            min="1"
                            max="10"
                            ...
                            className="w-full h-2 bg-ButtonColorPlus rounded-lg appearance-none"
                        />
                        <div
                            className="absolute bottom-6 ml-2 bg-ButtonColorPlus border border-ButtonColorPlus px-2 rounded-full"
                            style={{ left: `${(value - 1) * 10}%`, transform: 'translateX(-50%)' }}
                        >
                            {value}
                        </div>
                    </div>
